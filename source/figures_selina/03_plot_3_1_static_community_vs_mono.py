...
# This script lives in source/figures_selina/, but the shared figure modules
# (03_figure_config, 03_figure_utils) live one level up in source/. Add that
# directory to sys.path so importlib can find them.
