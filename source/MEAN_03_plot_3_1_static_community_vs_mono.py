...
"""
Figure 3.1:
Mean-based static salinity - community (stacked) vs monoculture (hatched)

This script creates the mean-based static community-vs-monoculture total biovolume figure.
...
out_png = os.path.join(
    output_dir,
    "MEAN_plot_3_1_static_community_vs_mono_biovolume_tot.png",
)
out_pdf = os.path.join(
    output_dir,
    "MEAN_plot_3_1_static_community_vs_mono_biovolume_tot.pdf",
)
...
comm_mat = pd.read_csv(
    os.path.join(DERIVED_DIR, "MEAN_comm_mat.csv"),
    index_col=0,
)
mono_mat = pd.read_csv(
    os.path.join(DERIVED_DIR, "MEAN_mono_mat.csv"),
    index_col=0,
)
...
print("Done: MEAN_plot_3_1_static_community_vs_mono")
